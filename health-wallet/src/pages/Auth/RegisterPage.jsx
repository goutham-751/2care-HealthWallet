    ...
    <div className="auth-page">
      <div className="auth-brand-panel">
        <div className="auth-brand-content">
          ...
          <h1>Join Health Wallet</h1>
          <p className="auth-brand-tagline">Your health data, securely managed.</p>
          ...
          <div className="auth-brand-quote">
            <p>"Security and ease of use in one platform. Finally."</p>
            <span>— Sarah Jenkins, Patient</span>
          </div>
        </div>
      </div>
